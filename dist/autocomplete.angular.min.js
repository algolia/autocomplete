...
"use strict";var DOM=require("../common/dom.js");DOM.element=angular.element;var EventBus=require("../autocomplete/event_bus.js"),Typeahead=require("../autocomplete/typeahead.js");angular.module("algolia.autocomplete",[]).directive("autocomplete",["$parse",function(t){return{restrict:"AC",scope:{options:"&aaOptions",datasets:"&aaDatasets"},link:function(e,o,a){function n(){i&&i.destroy(),i=new Typeahead({input:o,eventBus:s,hint:e.options.hint,minLength:e.options.minLength,autoselect:e.options.autoselect,openOnFocus:e.options.openOnFocus,templates:e.options.templates,debug:e.options.debug,datasets:e.datasets})}a=a,e.options=t(e.options)(e),e.options||(e.options={}),e.datasets=t(e.datasets)(e),e.datasets&&!angular.isArray(e.datasets)&&(e.datasets=[e.datasets]);var s=new EventBus({el:o}),i=null;e.$watch("options",n),angular.isArray(e.datasets)?e.$watchCollection("datasets",n):e.$watch("datasets",n),o.bind("autocomplete:selected",function(t,o,a){e.$emit("autocomplete:selected",o,a)}),o.bind("autocomplete:autocompleted",function(t,o,a){e.$emit("autocomplete:autocompleted",o,a)}),o.bind("autocomplete:opened",function(){e.$emit("autocomplete:opened")}),o.bind("autocomplete:closed",function(){e.$emit("autocomplete:closed")}),o.bind("autocomplete:cursorchanged",function(t,o,a){e.$emit("autocomplete:cursorchanged",t,o,a)})}}}]);
