...
"use strict";window.autocomplete=require("./src/standalone/index.js");
...
"use strict";function autocomplete(e,t,o){var n=Zepto(e),u=new EventBus({el:n});new Typeahead({input:n,eventBus:u,hint:void 0===t.hint?!0:!!t.hint,minLength:t.minLength,autoselect:t.autoselect,openOnFocus:t.openOnFocus,templates:t.templates,debug:t.debug,datasets:o})}var old$=window.$,Zepto=require("npm-zepto");require("npm-zepto/zepto/src/data.js"),window.$=old$;var DOM=require("../common/dom.js");DOM.element=Zepto;var _=require("../common/utils.js"),Typeahead=require("../autocomplete/typeahead.js"),EventBus=require("../autocomplete/event_bus.js");module.exports=autocomplete;
