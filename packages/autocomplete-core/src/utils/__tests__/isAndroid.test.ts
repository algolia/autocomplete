...
describe('isAndroid', () => {
  describe('Android', () => {
    ...
    describe('Firefox', () => {
      test('returns true with an Android 8 (mobile) user agent', () => {
        expect(
          isAndroid(
      ...
      test('returns true with a Android 9 (tablet) user agent', () => {
        expect(
          isAndroid(
    ...
    describe('Android Browser', () => {
      ...
      test('returns true with an Asus TF201 (tablet) user agent', () => {
        expect(
          isAndroid(
  ...
  describe('Windows', () => {
    describe('Chrome', () => {
      test('returns false with a Windows 7 (desktop) user agent', () => {
        expect(
          isAndroid(
